...
extern int ext2_init_security(struct inode *inode, struct inode *dir, void *label);
#else
static inline int ext2_init_security(struct inode *inode, struct inode *dir, void *label)
{
	return 0;
}
#endif
