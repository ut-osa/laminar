...
static int coda_symlink(struct inode *dir_inode, struct dentry *entry,
			const char *symname);
static int coda_mkdir(struct inode *dir_inode, struct dentry *entry, int mode, void *label);
...
static int coda_mkdir(struct inode *dir, struct dentry *de, int mode, void *label)
{
	struct inode *inode;
	struct coda_vattr attrs;
	const char *name = de->d_name.name;
